...
def my_tracer(frame, event, arg=None):
    ...
    if not hasattr(my_tracer, '_code_printed'):
        ...
        cfg = CFGBuilder().build_from_file("pytracex", "Calc_profit.py")
...
def htmlInit():
    ...
    # NOTE: Calc_profit.py is replaced with the name of the file by my-second-page.js
    print('''
		<!DOCTYPE html>
		<html>
    <head>
